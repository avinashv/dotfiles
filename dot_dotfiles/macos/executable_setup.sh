...
sudo scutil --set ComputerName "vader"
sudo scutil --set HostName "vader"
sudo scutil --set LocalHostName "vader"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "vader"
...
defaults write NSGlobalDomain AppleLocale -string "en_AE@currency=AED"
...
sudo systemsetup -settimezone "Asia/Dubai" > /dev/null
...
# Four-letter codes for the other view modes: `icnv`, `Nlsv`, `glyv`, `clmv`
...
# Show the ~/Library folder (broken on Apple Silicon)
